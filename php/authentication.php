  ...
  $sql2 = "INSERT INTO `2fa`(`OTP`) VALUES (md5('$otp'))";
   ...
   mysqli_query($conn, $sql2);
            ...
            //Compose and Send Email
                ...
                $mail->SMTPAuth = 'true';
                $mail->Username = 'aliyahabdi599@gmail.com'; //Your Gmail
                $mail->Password = 'qlwnbvbhcohgsnai'; //Your Gmail App Password
                $mail->SMTPSecure = 'ssl';
                $mail->Port = 465;

                $mail->setFrom('aliyahabdi599@gmail.com'); //Your Gmail
                $mail->addAddress($email); //Receiver Address
                $mail->isHTML(true);
                $mail->Subject = 'Dasani Order Management System Email Services - OTP Password for Login';
                $mail->Body = 'Dear Esteemed Client, '. $fname . ',

                We truly appreciate you for choosing Dasani, as your trusted source for pure and refreshing water. Below is your OTP for login attempt at ' .  date("Y-m-d h:i:s") . ', it expires in 3 minutes:
                <br>
                <br>
                <p><b>' . $otp . '</b></p>
                <br>
                ...
                <br>
                Kind Regards,
                Dasani Order Management System Team.';
  ...
  $sql2 = "INSERT INTO `2fa`(`OTP`) VALUES (md5('$otp'))";
   ...
   mysqli_query($conn, $sql2);
            ...
            //Compose and Send Email
                ...
                $mail->addAddress($email); //Receiver Address
                $mail->isHTML(true);
                $mail->Subject = 'Dasani Order Management System Email Services - OTP Password for Reset Credentials';
                $mail->Body = 'Dear Esteemed Client, '. $fname . ',

                We truly appreciate you for choosing Dasani, as your trusted source for pure and refreshing water. Below is your OTP for resetting your credentials attempt at ' .  date("Y-m-d h:i:s") . ', it expires in 3 minutes:
                <br>
                <br>
                <p><b>' . $otp . '</b></p>
                <br>
